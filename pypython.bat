...
:: pypython.bat 使用某个环境，在当前目录，执行用户输入的命令和参数。

if ""%1"" == """" (
    rem echo you can execute command with params in default env.
    echo usage:
    echo "  pypython <cmd-name> [ <cmd-params>... ]"
    echo -----
...
if not ""%9"" == """" (
    call "%PYPROGRAMPATHNAME%" python use %PYENVNAME% exec-with-params here %PYEXECNAME% --params %PYEXECPARAM[2]% --params %PYEXECPARAM[3]% --params %PYEXECPARAM[4]% --params %PYEXECPARAM[5]% --params %PYEXECPARAM[6]% --params %PYEXECPARAM[7]% --params %PYEXECPARAM[8]% --params %PYEXECPARAM[9]%
) else if not ""%8"" == """" (
    call "%PYPROGRAMPATHNAME%" python use %PYENVNAME% exec-with-params here %PYEXECNAME% --params %PYEXECPARAM[2]% --params %PYEXECPARAM[3]% --params %PYEXECPARAM[4]% --params %PYEXECPARAM[5]% --params %PYEXECPARAM[6]% --params %PYEXECPARAM[7]% --params %PYEXECPARAM[8]%
) else if not ""%7"" == """" (
    call "%PYPROGRAMPATHNAME%" python use %PYENVNAME% exec-with-params here %PYEXECNAME% --params %PYEXECPARAM[2]% --params %PYEXECPARAM[3]% --params %PYEXECPARAM[4]% --params %PYEXECPARAM[5]% --params %PYEXECPARAM[6]% --params %PYEXECPARAM[7]%
) else if not ""%6"" == """" (
    call "%PYPROGRAMPATHNAME%" python use %PYENVNAME% exec-with-params here %PYEXECNAME% --params %PYEXECPARAM[2]% --params %PYEXECPARAM[3]% --params %PYEXECPARAM[4]% --params %PYEXECPARAM[5]% --params %PYEXECPARAM[6]%
) else if not ""%5"" == """" (
    call "%PYPROGRAMPATHNAME%" python use %PYENVNAME% exec-with-params here %PYEXECNAME% --params %PYEXECPARAM[2]% --params %PYEXECPARAM[3]% --params %PYEXECPARAM[4]% --params %PYEXECPARAM[5]%
) else if not ""%4"" == """" (
    call "%PYPROGRAMPATHNAME%" python use %PYENVNAME% exec-with-params here %PYEXECNAME% --params %PYEXECPARAM[2]% --params %PYEXECPARAM[3]% --params %PYEXECPARAM[4]%
) else if not ""%3"" == """" (
    call "%PYPROGRAMPATHNAME%" python use %PYENVNAME% exec-with-params here %PYEXECNAME% --params %PYEXECPARAM[2]% --params %PYEXECPARAM[3]%
) else if not ""%2"" == """" (
    call "%PYPROGRAMPATHNAME%" python use %PYENVNAME% exec-with-params here %PYEXECNAME% --params %PYEXECPARAM[2]%
) else (
    call "%PYPROGRAMPATHNAME%" python use %PYENVNAME% exec-with-params here %PYEXECNAME%
)
